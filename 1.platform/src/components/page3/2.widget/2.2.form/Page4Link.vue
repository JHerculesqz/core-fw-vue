<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">Link</div>
    <div class="describe">
      Link
    </div>
    <!--1级 end-->
    <!--2级 start-->
    <div class="title level2">Link</div>
    <div class="describe">
      Link
    </div>
    <div class="showArea">
      <marvel-tab :tabItems="tabItems1">
        <marvel-tab-item :isActive="tabItems1[0].isActive">
          <div class="showAreaInner">
            ...
            <marvel-link ref="ref0" label="导航链接不可用" classCustom="classCustom1"
                         v-on:onClick="onClick"></marvel-link>
            <!--2级DemoView end-->
          </div>
        </marvel-tab-item>
...
<script>
  ...
  import MarvelLink from "@/walle/widget/link/MarvelLink"

  export default {
    name: 'page4Link',
    components: { MarvelTabItem,
      MarvelTab,MarvelLink},
    data: function() {
      return {
