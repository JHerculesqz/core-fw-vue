<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">List</div>
    <div class="describe">
      List
    </div>
    <!--1级 end-->
    <!--2级 start-->
    <div class="title level2">List</div>
    <div class="describe">
      List
    </div>
    <div class="showArea">
      <marvel-tab :tabItems="tabItems1">
        <marvel-tab-item :isActive="tabItems1[0].isActive">
          <div class="showAreaInner">
            ...
            <marvel-list2 :bargeCount="listBargeCount" title="Shit" ref="bbb"></marvel-list2>
            <!--2级DemoView end-->
          </div>
        </marvel-tab-item>
...
<script>
  ...
  import MarvelList2 from "@/walle/widget/list/MarvelList2";

  export default {
    name: 'page4List2',
    components: {
      MarvelTabItem,
      MarvelTab,MarvelList2},
    data: function() {
      return {
