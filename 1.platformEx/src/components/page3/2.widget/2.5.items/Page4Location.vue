<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">Location</div>
    <div class="describe">
      Location控件
    </div>
    <!--1级 end-->
    <!--2级 start-->
    <div class="title level2">Location</div>
    <div class="describe">
      Location
    </div>
    <div class="showArea">
        ...
        <marvel-tab-item :isActive="tabItems1[0].isActive">
          <div class="showAreaInner">
            ...
            <div style="width: 180px;height:100%">
              <button v-on:click="onClick">获取</button>
            </div>
            <!--2级DemoView end-->
          </div>
        </marvel-tab-item>
...
<script>
  ...
  import MarvelLocation from "marvel-fui2/src/walle/component/location"
  //#endregion
