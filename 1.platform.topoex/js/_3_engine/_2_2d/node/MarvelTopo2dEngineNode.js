(function ($) {
    $.MarvelTopo2dEngineNode = function (oParent) {
         ...
         */
        this.drawNode4DrawNodePath = function(oNodeGroup, oStartPoint, oEndPoint, oRes, oCanvasContext){
            ...
            if(oNodeGroup.params.uiEditNode){
                oCanvasContext.rect(oNodeGroup.params.uiPosX, oNodeGroup.params.uiPosY,oNodeGroup.params.uiImgWCur, oNodeGroup.params.uiImgHCur);
            }
            //如果是普通结点,都是绘制圆形
            else{
                var iWidth = oNodeGroup.params.uiImgWCur / 2;
                var iHeight = oNodeGroup.params.uiImgHCur / 2;
                oCanvasContext.rect(oNodeGroup.params.uiPosX + iWidth, oNodeGroup.params.uiPosY + iHeight, oNodeGroup.params.uiImgWCur/2 + NODE_SELECTION_TOLERANCE, 0, Math.PI * 2, true);
            }
         ...
         * @param oCanvasContext
         */
        this.drawNode = function(arrNodeGroup, iSlideWndZ, dicImages, oCanvasContext){
         ...
         * @param oNodeGroup
         */
        var drawNodeOutCircle = function(oCanvasContext, oNodeGroup){
